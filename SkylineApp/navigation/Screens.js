...
function MyPackagesStack(props) {
  return (
    <Stack.Navigator initialRouteName="My Packages" mode="card" headerMode="screen">
      <Stack.Screen
        name="My Packages"
...
export default function OnboardingStack(props) {
  ...
  const [initialRouteName, setInitialRoute] = useState('App')
  useEffect(() => {
