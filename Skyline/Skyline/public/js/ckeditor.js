...
(function () {
    if (window.CKEDITOR && window.CKEDITOR.dom) return; window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
            timestamp: "I63C", version: "4.10.0", revision: "de1371d", rnd: Math.floor(900 * Math.random()) + 100, _: { pending: [], basePathSrcPattern: a }, status: "unloaded", basePath: function () {
    ...
    (function () {
        function a(a) { a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset } function d(a, b, c, d, f) {
            function h(a, b, c, e) { var d = c ? a.getPrevious() : a.getNext(); if (e && k) return d; l || e ? b.append(a.clone(!0, f), c) : (a.remove(), r && b.append(a, c)); return d } function m() { var a, b, c, e = Math.min(O.length, p.length); for (a = 0; a < e; a++)if (b = O[a], c = p[a], !b.equals(c)) return a; return a - 1 } function g() {
                var b = N - 1, c = E && z && !t.equals(F); b < w - 1 || b < B - 1 || c ? (c ? a.moveToPosition(F,
    ...
    (function () {
        function a(a, b, c, d, f) {
            var e, w; a = []; for (e in b) {
                ...
                l[m] = k(l[m], p) || null; var h = l, t = O[m], q = k(l[O[m]], p), z = l[m], B = [], g = !0, H = void 0; q ? g = !1 : q = {}; for (H in z) "!" == H.charAt(0) && (H = H.slice(1), B.push(H), q[H] = !0, g = !1); for (; H = B.pop();)z[H] =
                    z["!" + H], delete z["!" + H]; h[t] = (g ? !1 : q) || null
                } l.match = l.match || null; d.push(w); a.push(w)
            } b = f.elements; f = f.generic; var F; c = 0; for (d = a.length; c < d; ++c) {
                e = E(a[c]); w = !0 === e.classes || !0 === e.styles || !0 === e.attributes; l = e; m = t = p = void 0; for (p in P) l[p] = J(l[p]); h = !0; for (m in O) { p = O[m]; t = l[p]; q = []; z = void 0; for (z in t) -1 < z.indexOf("*") ? q.push(new RegExp("^" + z.replace(/\*/g, ".*") + "$")) : q.push(z); t = q; t.length && (l[p] = t, h = !1) } l.nothingRequired = h; l.noProperties = !(l.attributes || l.classes || l.styles); if (!0 === e.elements ||
            ...
            this.allowedContent = []; this.disallowedContent = []; this.elementCallbacks = null; this.disabled =
                ...
                allow: function (b, c, d) {
                    ...
                    a.forEach(function (a) {
                        if (a.type == CKEDITOR.NODE_ELEMENT) { if ("off" == a.attributes["data-cke-filter"]) return !1; if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (p = A(f, a, e, t), p & 1) h = !0; else if (p & 2) return !1 } else if (a.type == CKEDITOR.NODE_COMMENT && a.value.match(/^\{cke_protected\}(?!\{C\})/)) {
                            var c; a: {
                ...
                addContentForms: function (a) { if (!this.disabled && a) { var b, c, d = [], f; for (b = 0; b < a.length && !f; ++b)c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (f = c); if (f) { for (b = 0; b < a.length; ++b)d.push(L(a[b], f)); this.addTransformations(d) } } }, addElementCallback: function (a) { this.elementCallbacks || (this.elementCallbacks = []); this.elementCallbacks.push(a) }, addFeature: function (a) {
                    ...
                    } else d = a.getDefinition(), f = d.styles, l = d.attributes || {}, f && !CKEDITOR.tools.isEmpty(f) ? (f = E(f), l.style = CKEDITOR.tools.writeCssText(f, !0)) : f = {}, f = { name: d.element, attributes: l, classes: l["class"] ? l["class"].split(/\s+/) : [], styles: f, children: [] }; var l = CKEDITOR.tools.clone(f), p = [], h; if (!1 !== b && (h = this._.transformations[f.name])) {
                        for (d =
        ...
        var P = { styles: 1, attributes: 1, classes: 1 }, O = { styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses" }, p = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, N = { styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/ }, w = /^cke:(object|embed|param)$/, B = /^(object|embed|param)$/, G; G = CKEDITOR.filter.transformationsTools = {
            sizeToStyle: function (a) { this.lengthToStyle(a, "width"); this.lengthToStyle(a, "height") }, sizeToAttribute: function (a) {
                ...
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, f = c.attributes, e, l, w, p; a.name = c.element; for (e in f) if ("class" == e) for (c = a.classes.join("|"), w = f[e].split(/\s+/); p = w.pop();)-1 == c.indexOf(p) && a.classes.push(p); else a.attributes[e] = f[e]; for (l in d) a.styles[l] =
                        d[l]
                }
            }
        }
        ...
        var a = {}, d = {}; return {
            load: function (b, c, f, h) {
                var k = "string" == typeof b; k && (b = [b]); f || (f = CKEDITOR); var g = b.length, n = [], r = [], e = function (a) { c && (k ? c.call(f, a) : c.call(f, n, r)) }; if (0 === g) e(!0); else {
                    var y = function (a, b) { (b ? n : r).push(a); 0 >= --g && (h && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), e(b)) }, v = function (b, c) { a[b] = 1; var f = d[b]; delete d[b]; for (var e = 0; e < f.length; e++)f[e](b, c) }, A = function (b) {
                        if (a[b]) y(b, !0); else {
        ...
        var d = {}; return function (b, c, f) {
            var h = {}, k = function (b) {
                a.call(this, b, function (a) {
                    CKEDITOR.tools.extend(h, a); var b = [], e; for (e in a) { var g = a[e], v = g && g.requires; if (!d[e]) { if (g.icons) for (var A = g.icons.split(","), D = A.length; D--;)CKEDITOR.skin.addIcon(A[D], g.path + "icons/" + (CKEDITOR.env.hidpi && g.hidpi ? "hidpi/" : "") + A[D] + ".png"); d[e] = 1 } if (v) for (v.split && (v = v.split(",")), g = 0; g < v.length; g++)h[v[g]] || b.push(v[g]) } if (b.length) k.call(this,
    ...
    (function () {
        ...
        function n(a) { CKEDITOR.skin.loadPart("editor", function () { r(a) }) } function r(a) { CKEDITOR.lang.load(a.config.language, a.config.defaultLanguage, function (b, c) { var d = a.config.title; a.langCode = b; a.lang = CKEDITOR.tools.prototypedCopy(c); a.title = "string" == typeof d || !1 === d ? d : [a.lang.editor, a.name].join(", "); a.config.contentsLangDirection || (a.config.contentsLangDirection = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? a.element.getDirection(1) : a.lang.dir); a.fire("langLoaded"); e(a) }) } function e(a) {
            ...
            function b(a) { if (!a) return ""; CKEDITOR.tools.isArray(a) && (a = a.join(",")); return a.replace(/\s/g, "") } var c = a.config, d = b(c.plugins), f = b(c.extraPlugins), e = b(c.removePlugins); if (f) var h = new RegExp("(?:^|,)(?:" + f.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), d = d.replace(h, ""), d = d + ("," + f); if (e) var g = new RegExp("(?:^|,)(?:" + e.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), d = d.replace(g, ""); CKEDITOR.env.air && (d += ",adobeair"); CKEDITOR.plugins.load(d.split(","),
                function (b) {
                    var d = [], f = [], e = []; a.plugins = b; for (var l in b) {
                        var h = b[l], t = h.lang, k = null, p = h.requires, F; CKEDITOR.tools.isArray(p) && (p = p.join(",")); if (p && (F = p.match(g))) for (; p = F.pop();)CKEDITOR.error("editor-plugin-required", { plugin: p.replace(",", ""), requiredBy: l }); t && !a.lang[l] && (t.split && (t = t.split(",")), 0 <= CKEDITOR.tools.indexOf(t, a.langCode) ? k = a.langCode : (k = a.langCode.replace(/-.*/, ""), k = k != a.langCode && 0 <= CKEDITOR.tools.indexOf(t, k) ? k : 0 <= CKEDITOR.tools.indexOf(t, "en") ? "en" : t[0]), h.langEntries && h.langEntries[k] ?
                            (a.lang[l] = h.langEntries[k], k = null) : e.push(CKEDITOR.getUrl(h.path + "lang/" + k + ".js"))); f.push(k); d.push(h)
        ...
        } function v() { var a = this.element; if (a && this.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO) { var b = this.getData(); this.config.htmlEncodeOutput && (b = CKEDITOR.tools.htmlEncode(b)); a.is("textarea") ? a.setValue(b) : a.setHtml(b); return !0 } return !1 } function A(a, b) {
            ...
            a; var D = 0, x = {}; CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
                addCommand: function (a, b) { b.name = a.toLowerCase(); var c = b instanceof CKEDITOR.command ? b : new CKEDITOR.command(this, b); this.mode && f(this, c); return this.commands[a] = c }, _attachToForm: function () {
                    function a(b) { c.updateElement(); c._.required && !d.getValue() && !1 === c.fire("required") && b.data.preventDefault() } function b(a) { return !!(a && a.call && a.apply) } var c = this, d = c.element, f = new CKEDITOR.dom.element(d.$.form); d.is("textarea") && f && (f.on("submit",
                        a), b(f.$.submit) && (f.$.submit = CKEDITOR.tools.override(f.$.submit, function (b) { return function () { a(); b.apply ? b.apply(this) : b() } })), c.on("destroy", function () { f.removeListener("submit", a) }))
                }, destroy: function (a) { this.fire("beforeDestroy"); !a && v.call(this); this.editable(null); this.filter && (this.filter.destroy(), delete this.filter); delete this.activeFilter; this.status = "destroyed"; this.fire("destroy"); this.removeAllListeners(); CKEDITOR.remove(this); CKEDITOR.fire("instanceDestroyed", null, this) }, elementPath: function (a) {
                    if (!a) {
                        a =
                        this.getSelection(); if (!a) return null; a = a.getStartElement()
                ...
                getData: function (a) { !a && this.fire("beforeGetData"); var b = this._.data; "string" != typeof b && (b = (b = this.element) && this.elementMode == CKEDITOR.ELEMENT_MODE_REPLACE ? b.is("textarea") ? b.getValue() : b.getHtml() : ""); b = { dataValue: b }; !a && this.fire("getData", b); return b.dataValue }, getSnapshot: function () { var a = this.fire("getSnapshot"); "string" != typeof a && (a = (a = this.element) && this.elementMode == CKEDITOR.ELEMENT_MODE_REPLACE ? a.is("textarea") ? a.getValue() : a.getHtml() : ""); return a }, loadSnapshot: function (a) {
                    this.fire("loadSnapshot",
                        a)
                }, setData: function (a, b, c) { var d = !0, f = b; b && "object" == typeof b && (c = b.internal, f = b.callback, d = !b.noSnapshot); !c && d && this.fire("saveSnapshot"); if (f || !c) this.once("dataReady", function (a) { !c && d && this.fire("saveSnapshot"); f && f.call(a.editor) }); a = { dataValue: a }; !c && this.fire("setData", a); this._.data = a.dataValue; !c && this.fire("afterSetData", a) }, setReadOnly: function (a) { a = null == a || a; this.readOnly != a && (this.readOnly = a, this.keystrokeHandler.blockedKeystrokes[8] = +a, this.editable().setReadOnly(a), this.fire("readOnly")) },
                insertHtml: function (a, b, c) { this.fire("insertHtml", { dataValue: a, mode: b, range: c }) }, insertText: function (a) { this.fire("insertText", a) }, insertElement: function (a) { this.fire("insertElement", a) }, getSelectedHtml: function (a) { var b = this.editable(), c = this.getSelection(), c = c && c.getRanges(); if (!b || !c || 0 === c.length) return null; b = A(c, b); return a ? b.getHtml() : b }, extractSelectedHtml: function (a, b) {
                    var c = this.editable(), d = this.getSelection().getRanges(), f = new CKEDITOR.dom.documentFragment, e; if (!c || 0 === d.length) return null;
                    for (e = 0; e < d.length; e++)f.append(c.extractHtmlFromRange(d[e], b)); b || this.getSelection().selectRanges([d[0]]); return a ? f.getHtml() : f
                    ...
                    a || (a = this.filter); this.activeFilter !== a &&
                    ...
                    if (a(e)) m.push(e); else {
                        if ("pre" == f) l = !0; else { if ("br" == f && l) { u.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == f && (K = !0) } if ("br" == f) J.push(e); else {
                            for (; !(g = (h = u.name) ? CKEDITOR.dtd[h] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, e.isUnknown || u.isUnknown || g[f]);)if (u.isOptionalClose) D.onTagClose(h); else if (f in b && h in b) h = u.children, (h = h[h.length - 1]) && "li" == h.name || y(h = new CKEDITOR.htmlParser.element("li"), u), !e.returnPoint && (e.returnPoint = u), u = h; else if (f in CKEDITOR.dtd.$listItem &&
                                !A(f, h)) D.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1); else if (h in d && !A(f, h)) !e.returnPoint && (e.returnPoint = u), u = u.parent; else if (h in CKEDITOR.dtd.$inline && m.unshift(u), u.parent) y(u, u.parent, 1); else { e.isOrphan = 1; break } n(f); r(); e.parent = u; e.isEmpty ? y(e) : u = e
                        }
                    }
    ...
    (function () {
        function a(a, d) {
        ...
        } function e(a, b) { return a.replace(b, function (a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + A(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) } function y(a) { return a.replace(P, function (a, b) { return decodeURIComponent(b) }) } function v(a) {
            ...
            }); var M = /<(a|area|img|input|source)\b([^>]*)>/gi, q = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, E = /^(href|src|name)$/i, z = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, H = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, P = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, O = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi, p = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, N = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
        ...
        function g(a) { return a.activeEnterMode != CKEDITOR.ENTER_BR && !1 !== a.config.autoParagraph ? a.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : !1 } function n(a) { var b = a.editor; b.getSelection().scrollIntoView(); setTimeout(function () { b.fire("saveSnapshot") }, 0) } function r(a, b, c) { var d = a.getCommonAncestor(b); for (b = a = c ? b : a; (a = a.getParent()) && !d.equals(a) && 1 == a.getChildCount();)b = a; b.remove() } var e, y, v, A, D, x, m, J, u, K; CKEDITOR.editable = CKEDITOR.tools.createClass({
                                    ...
                                    a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup", function (b) { b.data.getKeystroke() in q && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select()) }); this.attachListener(this, "dblclick", function (b) { if (a.readOnly) return !1; b = { element: b.data.getTarget() }; a.fire("doubleclick", b) }); CKEDITOR.env.ie && this.attachListener(this, "click", b); CKEDITOR.env.ie && !CKEDITOR.env.edge || this.attachListener(this, "mousedown",
                                        function (b) { var c = b.data.getTarget(); c.is("img", "hr", "input", "textarea", "select") && !c.isReadOnly() && (a.getSelection().selectElement(c), c.is("input", "textarea", "select") && b.data.preventDefault()) }); CKEDITOR.env.edge && this.attachListener(this, "mouseup", function (b) { (b = b.data.getTarget()) && b.is("img") && !b.isReadOnly() && a.getSelection().selectElement(b) }); CKEDITOR.env.gecko && this.attachListener(this, "mouseup", function (b) {
                                            if (2 == b.data.$.button && (b = b.data.getTarget(), !b.getOuterHtml().replace(D, ""))) {
                                                var c =
                                                    a.createRange(); c.moveToElementEditStart(b); c.select(!0)
                                            }
            ...
            var b = a.editor; b.on("mode", function () {
                var a = b.editable(); if (a && a.isInline()) {
                    var c = b.title; a.changeAttr("role", "textbox"); a.changeAttr("aria-multiline", "true"); a.changeAttr("aria-label", c); c && a.changeAttr("title", c); var d =
                        b.fire("ariaEditorHelpLabel", {}).label; if (d && (c = this.ui.space(this.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? "top" : "contents"))) { var e = CKEDITOR.tools.getNextId(), d = CKEDITOR.dom.element.createFromHtml('\x3cspan id\x3d"' + e + '" class\x3d"cke_voice_label"\x3e' + d + "\x3c/span\x3e"); c.append(d); a.changeAttr("aria-describedby", e) }
                }
            })
        }); CKEDITOR.addCss(".cke_editable{cursor:text}.cke_editable img,.cke_editable input,.cke_editable textarea{cursor:default}"); e = CKEDITOR.dom.walker.whitespaces(!0); y = CKEDITOR.dom.walker.bookmark(!1,
            !0); v = CKEDITOR.dom.walker.empty(); A = CKEDITOR.dom.walker.bogus(); D = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi; x = function () {
                function a(b) { return b.type == CKEDITOR.NODE_ELEMENT } function b(c, d) {
                    var e, f, g, q, h = [], z = d.range.startContainer; e = d.range.startPath(); for (var z = E[z.getName()], k = 0, H = c.getChildren(), m = H.count(), n = -1, r = -1, C = 0, P = e.contains(E.$list); k < m; ++k)e = H.getItem(k), a(e) ? (g = e.getName(), P && g in CKEDITOR.dtd.$list ?
                    ...
                    for (k && e.push(" "); h < g; h++)q = f.getItem(h), a(q) && !q.is(z) ? e = e.concat(d(q, c)) : e.push(q); k && e.push(" "); return e
                    ...
                    var f = b.clone(), g, q; f.setEndAt(c, CKEDITOR.POSITION_BEFORE_END); (g = (new CKEDITOR.dom.walker(f)).next()) && a(g) && z[g.getName()] && (q = g.getPrevious()) && a(q) && !q.getParent().equals(b.startContainer) && d.contains(q) &&
                    ...
                    var B = z.editor, G = !1; "unfiltered_html" == p && (p = "html", G = !0); if (!w.checkReadOnly()) {
                        ...
                        if (B = n.contains(f, !1, 1)) p.splitElement(B), z.inlineStylesRoot = B, z.inlineStylesPeak = n.lastElement; n = p.createBookmark(); (B = n.startNode.getPrevious(c)) && a(B) && f(B) && w.push(B); (B = n.startNode.getNext(c)) && a(B) && f(B) && w.push(B); for (B = n.startNode; (B = B.getParent()) && f(B);)w.push(B); p.moveToBookmark(n); if (n = N) {
                            ...
                            y = z.range; n = y.document; var u; r = z.blockLimit; w = 0; var A, x = [], D, T; N = B = 0; var J, K; p = y.startContainer; var G = z.endPath.elements[0], W, I = G.getPosition(p), v = !!G.getCommonAncestor(p) && I != CKEDITOR.POSITION_IDENTICAL && !(I & CKEDITOR.POSITION_CONTAINS +
                                CKEDITOR.POSITION_IS_CONTAINED); p = b(z.dataWrapper, z); for (q(p, y); w < p.length; w++) {
                                    I = p[w]; if (u = I.isLineBreak) { u = y; J = r; var S = void 0, Y = void 0; I.hasBlockSibling ? u = 1 : (S = u.startContainer.getAscendant(E.$block, 1)) && S.is({ div: 1, p: 1 }) ? (Y = S.getPosition(J), Y == CKEDITOR.POSITION_IDENTICAL || Y == CKEDITOR.POSITION_CONTAINS ? u = 0 : (J = u.splitElement(S), u.moveToPosition(J, CKEDITOR.POSITION_AFTER_START), u = 1)) : u = 0 } if (u) N = 0 < w; else {
                                        u = y.startPath(); !I.isBlock && k(z.editor, u.block, u.blockLimit) && (T = g(z.editor)) && (T = n.createElement(T),
                                            T.appendBogus(), y.insertNode(T), CKEDITOR.env.needsBrFiller && (A = T.getBogus()) && A.remove(), y.moveToPosition(T, CKEDITOR.POSITION_BEFORE_END)); if ((u = y.startPath().block) && !u.equals(D)) { if (A = u.getBogus()) A.remove(), x.push(u); D = u } I.firstNotAllowed && (B = 1); if (B && I.isElement) {
                                            ...
                                            } if (W) { for (; u = W.pop();)y.insertNode(u); W = 0 } else y.insertNode(I.node); I.lastNotAllowed && w < p.length - 1 && ((K = v ? G : K) && y.setEndAt(K, CKEDITOR.POSITION_AFTER_START), B = 0); y.collapse()
                                    }
                                } 1 != p.length ? A = !1 : (A = p[0], A = A.isElement && "false" == A.node.getAttribute("contenteditable")); A && (N = !0, u = p[0].node, y.setStartAt(u, CKEDITOR.POSITION_BEFORE_START),
                                    y.setEndAt(u, CKEDITOR.POSITION_AFTER_END)); z.dontMoveCaret = N; z.bogusNeededBlocks = x
                        } A = z.range; var R; K = z.bogusNeededBlocks; for (W = A.createBookmark(); D = z.zombies.pop();)D.getParent() && (T = A.clone(), T.moveToElementEditStart(D), T.removeEmptyBlocksAtEnd()); if (K) for (; D = K.pop();)CKEDITOR.env.needsBrFiller ? D.appendBogus() : D.append(A.document.createText(" ")); for (; D = z.mergeCandidates.pop();)D.mergeSiblings(); A.moveToBookmark(W); if (!z.dontMoveCaret) {
                            for (D = e(A); D && a(D) && !D.is(E.$empty);) {
                                if (D.isBlockBoundary()) A.moveToPosition(D,
                                    CKEDITOR.POSITION_BEFORE_END); else { if (f(D) && D.getHtml().match(/(\s|&nbsp;)$/g)) { R = null; break } R = A.clone(); R.moveToPosition(D, CKEDITOR.POSITION_BEFORE_END) } D = D.getLast(c)
                            } R && A.moveToRange(R)
                        }
                    }
                }
                        ...
                        function a(c) {
                            var e =
                                [], f, g = new CKEDITOR.dom.walker(c), h = c.startPath().contains(d), k = c.endPath().contains(d), p = {}; g.guard = function (a, g) {
                                    if (a.type == CKEDITOR.NODE_ELEMENT) { var B = "visited_" + (g ? "out" : "in"); if (a.getCustomData(B)) return; CKEDITOR.dom.element.setMarker(p, a, B, 1) } if (g && h && a.equals(h)) f = c.clone(), f.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(f); else if (!g && k && a.equals(k)) f = c.clone(), f.setStartAt(k, CKEDITOR.POSITION_AFTER_START), e.push(f); else {
    ...
    (function () {
        ...
        } function v(a, b) { return b ? a.replace(K, function (a, b) { return b ? " " : "" }) : a.replace(u, "") } function A(a, b) {
            ...
            function b() {
                ...
                function a() { r = new CKEDITOR.dom.selection(c.getSelection()); r.lock() } function b() { f.removeListener("mouseup", b); q.removeListener("mouseup", b); var a = CKEDITOR.document.$.selection, c = a.createRange(); "None" != a.type && c.parentElement() && c.parentElement().ownerDocument == e.$ && c.select() } function d(a) {
                    ...
                    CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function () { n && CKEDITOR.env.webkit && (n = c._.previousActive && c._.previousActive.equals(e.getActive())) && null != c._.previousScrollTop && c._.previousScrollTop != g.$.scrollTop && (g.$.scrollTop = c._.previousScrollTop); c.unlockSelection(n); n = 0 }, null, null, -1); g.attachListener(g, "mousedown", function () { n = 0 }); if (CKEDITOR.env.ie || E) m ? g.attachListener(g, "beforedeactivate", a, null, null, -1) : g.attachListener(c, "selectionCheck", a, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit ?
                        "DOMFocusOut" : "blur", function () { c.lockSelection(r); n = 1 }, null, null, -1), g.attachListener(g, "mousedown", function () { n = 0 }); if (CKEDITOR.env.ie && !E) {
    ...
    (function () {
        function a(a, b) { for (var c, d; (a = a.getParent()) && !a.equals(b);)if (a.getAttribute("data-nostyle")) c = a; else if (!d) { var e = a.getAttribute("contentEditable"); "false" == e ? c = a : "true" == e && (d = 1) } return c } function d(a, b, c, d) { return (a.getPosition(b) | d) == d && (!c.childRule || c.childRule(a)) } function b(c) {
                            ...
                            for (var l = J(this, e), x = l.hasAttributes(), A = u.getCommonAncestor(), y = {}, E = {}, F = {}, H = {}, U, R, aa; l && A;) {
                                if (A.getName() == g) {
                                    for (U in h.attributes) !H[U] && (aa = A.getAttribute(R)) &&
                                        (l.getAttribute(U) == aa ? E[U] = 1 : H[U] = 1); for (R in h.styles) !F[R] && (aa = A.getStyle(R)) && (l.getStyle(R) == aa ? y[R] = 1 : F[R] = 1)
                                } A = A.getParent()
            ...
            function b() { for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(n.getParent()), e = null, f = null, g = 0; g < a.elements.length; g++) { var h = a.elements[g]; if (h == a.block || h == a.blockLimit) break; r.checkElementRemovable(h, !0) && (e = h) } for (g = 0; g < c.elements.length; g++) { h = c.elements[g]; if (h == c.block || h == c.blockLimit) break; r.checkElementRemovable(h, !0) && (f = h) } f && n.breakParent(f); e && d.breakParent(e) } a.enlarge(CKEDITOR.ENLARGE_INLINE, 1); var c =
                ...
                } else { var n = c.endNode, r = this; b(); for (f = d; !f.equals(n);)g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? A.call(this, f) : x(f, l(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), f = g } a.moveToBookmark(c); a.shrink(CKEDITOR.NODE_ELEMENT, !0)
        } function f(a) {
            var b =
